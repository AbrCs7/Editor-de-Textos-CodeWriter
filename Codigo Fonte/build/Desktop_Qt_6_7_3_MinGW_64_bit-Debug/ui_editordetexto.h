...
public:
    ...
    QAction *actionRetroceder;
    QAction *actionEnumerar_Linhas;
    ...
    void setupUi(QMainWindow *EditorDeTexto)
    {
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/img/saveC.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionSalvar_Como->setIcon(icon4);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/img/cut.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionRecortar->setIcon(icon8);
        actionRefazer = new QAction(EditorDeTexto);
        actionRefazer->setObjectName("actionRefazer");
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/img/redo.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionRefazer->setIcon(icon9);
        actionDesfazer = new QAction(EditorDeTexto);
        actionDesfazer->setObjectName("actionDesfazer");
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/img/undo.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionDesfazer->setIcon(icon10);
        actionCor = new QAction(EditorDeTexto);
        actionCor->setObjectName("actionCor");
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/img/highlight.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionCor->setIcon(icon11);
        actionBackgroud = new QAction(EditorDeTexto);
        actionBackgroud->setObjectName("actionBackgroud");
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/img/background.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionBackgroud->setIcon(icon12);
        actionFonte = new QAction(EditorDeTexto);
        actionFonte->setObjectName("actionFonte");
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/img/font.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionFonte->setIcon(icon13);
        actionSobre_esse_programa = new QAction(EditorDeTexto);
        actionSobre_esse_programa->setObjectName("actionSobre_esse_programa");
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/img/about.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionSobre_esse_programa->setIcon(icon14);
        actionImprimir = new QAction(EditorDeTexto);
        actionImprimir->setObjectName("actionImprimir");
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/img/print.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionImprimir->setIcon(icon15);
        actionPesquisar = new QAction(EditorDeTexto);
        actionPesquisar->setObjectName("actionPesquisar");
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/img/search.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionPesquisar->setIcon(icon16);
        actionAvan_ar = new QAction(EditorDeTexto);
        actionAvan_ar->setObjectName("actionAvan_ar");
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/img/avancar.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionAvan_ar->setIcon(icon17);
        actionRetroceder = new QAction(EditorDeTexto);
        actionRetroceder->setObjectName("actionRetroceder");
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/img/retroceder.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionRetroceder->setIcon(icon18);
        actionEnumerar_Linhas = new QAction(EditorDeTexto);
        actionEnumerar_Linhas->setObjectName("actionEnumerar_Linhas");
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/img/enum.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionEnumerar_Linhas->setIcon(icon19);
        ...
        menuEditar->addAction(actionEnumerar_Linhas);
        ...
        menuPesquisar->addAction(actionAvan_ar);
        menuPesquisar->addAction(actionRetroceder);
        ...
        toolBar->addSeparator();
        toolBar->addAction(actionEnumerar_Linhas);
        toolBar->addSeparator();
        toolBar->addAction(actionRetroceder);
    ...
    void retranslateUi(QMainWindow *EditorDeTexto)
    {
        ...
        actionAvan_ar->setText(QCoreApplication::translate("EditorDeTexto", "Avan\303\247ar", nullptr));
        actionRetroceder->setText(QCoreApplication::translate("EditorDeTexto", "Retroceder", nullptr));
        actionEnumerar_Linhas->setText(QCoreApplication::translate("EditorDeTexto", "Enumerar Linhas", nullptr));
